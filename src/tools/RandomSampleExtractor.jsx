...
export default function RandomSampleExtractor() {
  ...
  return (
    <div className="tool-body">
      <MultiFilePicker id="sample-input" files={files} sheets={sheets} activeSheetIndex={activeSheetIndex} busy={busy} onAdd={addFiles} onRemove={removeFile} onSelectSheet={setActiveSheetIndex} />
