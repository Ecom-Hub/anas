...
export default function ExtractDomain() {
  ...
  return (
    <div className="tool-body">
      <MultiFilePicker id="domain-input" files={files} sheets={sheets} activeSheetIndex={activeSheetIndex} busy={busy} onAdd={addFiles} onRemove={removeFile} onSelectSheet={setActiveSheetIndex} />
